    ...
    public void putTogetherTheStory() {
        ...
        if (num == 2) {
            story = "Jesse and her best friend " + getName() + " went to Disney World today!" + "They saw a "
                    ...
                    + " feast for dinner." + " The next day I ran" + getAdverb() + " to meet Micey Mouse in his "
                    + getNoun2()
                    + " and then i gazed at the " + getRandomNums() + " " + getAdjective2()
                    + " fireworks shooting from the " + getNoun3() + ".";
            setStory(story);
        } else {
            story = "Amanda and her friend Frenemy " + getName() + " went to the zoo last summer. " + "They saw a huge "
